<section class="enticement">
	<div class="enticement__wrap-head-text">
		<h2 class="enticement__head-text">How we add value to your business</h2>
	</div>
	<div class="enticement__cards">
		<div class="enticement__container-conversion">
			...
			<p class="enticement__card-desc">A well though out and tested UX can take your product a long way. No more users dropping off in 7 seconds because of frustration. No more need to lie about how your app “worked just fine before I showed it to you”</p>
		</div>
		<div class="enticement__container-articles">
			...
			<div class="enticement__card-art">
				...
				<p class="enticement__card-desc">Starting a new product is hard and funding is necessary 90% of the time.But in order to get — just having an idea is not enough… Let us bring your vision to life without and development cost</p>
			</div>
		</div>
	</div>
</section>