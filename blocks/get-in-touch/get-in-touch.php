<section class="get-in-touch">
	<h2 class="get-in-touch__title-block">Get in touch</h2>
	<div class="get-in-touch__container-cnt-form-n-team-n-boost">
		...
		<div class="get-in-touch__container-team-n-boost">
			...
			<div class="get-in-touch__container-boost">
				<div class="get-in-touch__box-list-boosts-n-list-desc">
					<div class="get-in-touch__phrase">Let us boost your:</div>
					<ul class="get-in-touch__list-boosts">
						<li class="get-in-touch__list-boosts-item">sales</li>
						<li class="get-in-touch__list-boosts-item">image</li>
						<li class="get-in-touch__list-boosts-item">user experience</li>
					</ul>
				</div>
				<p class="get-in-touch__box-list-desc">ALMAX is a strategically driven, digital-first agency that lives at the intersection of creativity and technology. We solve consumer and business problems with end-to-end solutions that flex to meet the needs of today`s ever-changing digital landscape.</p>
			</div>
		</div>
	</div>
</section>